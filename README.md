...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/frankfurter_get_latest \
  -H 'Content-Type: application/json' \
  -d '{"base":"USD","symbols":"EUR,GBP,JPY"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/frankfurter_get_latest`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
